...
const yutto = document.getElementById('yutto');
yutto.addEventListener('click', () => {
    yutto.style.transition = 'transform 0.6s ease';
    yutto.style.transform = 'rotate(360deg)';
    setTimeout(() => {
        yutto.style.transform = 'rotate(0deg)';
    }, 600);
});
